...
import hackshackattack from '../static/hackshackattack.png'
import highscoretext from '../static/highscoretext.png'
import itmonster from '../static/itmonster.png'
      ...
      >
        ...
        >
          <Box
            ...
            height="296px"
          >
            <Image fit="contain" src={hackshackattack} />
          </Box>
          <Box
            margin="large"
            width="553px"
            height="96px"
          >
            <Image fit="contain" src={highscoretext}/>
          </Box>
        </Box>
        <Box
        ...
        <Box align="end">
          <Box
            ...
            justify="end"
          >
            <Image fit="contain" src={itmonster}/>
          </Box>
        </Box>
      </Box>
    );
